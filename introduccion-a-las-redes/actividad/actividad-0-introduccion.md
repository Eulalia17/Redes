...
1. Ir a los ajustes del espacio en GitBook: Entramos en el espacio de trabajo de GitBook. En el menú lateral, busca la opción de GitHub.
2. Autorizar la integración con GitHub: Haz clic en conectar con GitHu&#x62;_._ Te redirigirá a GitHub para autorizar la aplicación de GitBook. Selecciona únicamente al repositorio específico de tu proyecto.
3. Configurar el repositorio y la rama (_Branch_): Selecciona tu cuenta de usuario de GitHub. Elige el repositorio que quieres vincular (por ejemplo, el de la memoria de tu proyecto). Selecciona la rama principal que quieres sincronizar (habitualmente `main` ).
...
5. Confirmar la sincronización inicial:Haz clic en Save. GitBook importará los archivos de tu repositorio de GitHub.
